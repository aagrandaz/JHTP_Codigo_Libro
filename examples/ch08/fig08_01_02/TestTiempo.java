public class TestTiempo {
    public static void main(String[] args) {
        ...
        mostrarTiempo("Despues de crear el objeto de tiempo", hora);
        System.out.println();

        // modifica la hora e imprime la hora actualizada :
        hora.establecerTiempo(12, 27, 6);
        mostrarTiempo("Despues de llmar a establecerTiempo", hora);
        System.out.println();
        ...
        try {
            ...
            System.out.println("Exepcion: %s%n%n", e.getMessage());
        }
